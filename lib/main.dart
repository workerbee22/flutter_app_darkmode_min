...
/// Themes are provided by the default theme data of ThemeData.light() or ThemeData.dark(). Colors for both light and
/// dark themes come from these two default theme data that Flutter provides.
///
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // *** Change two properties enable dark mode that follows the operating system setting for light or dark theme
